...
type Page = 'dashboard' | 'users' | 'budgets' | 'stats' | 'accounts' | 'pools' | 'tasks' | 'settings' | 'error-diagnostics' | 'diagnostics';
...
const pages: { id: Page; label: string; description: string }[] = [
  ...
  { id: 'pools', label: 'Account Pools', description: 'One exposed identity backed by many accounts, with session stickiness and cache affinity.' },
    ...
    <div className="min-h-screen bg-slate-100">
      ...
      <div className="lg:pl-64">
        ...
        <main className="p-6">
          ...
          {page === 'pools' ? <PoolsPage notify={notify} /> : null}
